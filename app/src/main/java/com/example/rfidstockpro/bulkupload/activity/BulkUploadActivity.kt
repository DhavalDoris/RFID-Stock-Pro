      ...
      try {
        ...
        runOnUiThread {
          ...
          if (missingHeaders.isNotEmpty()) {
            binding.tvMissingMessage.text = "Missing fields in Excel: ${missingHeaders.joinToString(", ")}"
  ...
  private fun startBulkUpload(fileUri: Uri) {
    ...
    viewModel.uploadProductsFromExcel(
      ...
      onComplete = { success, failure ->
        Toast.makeText(this, "Uploaded! Success: $success, Failed: $failure", Toast.LENGTH_LONG).show()
        runOnUiThread {
