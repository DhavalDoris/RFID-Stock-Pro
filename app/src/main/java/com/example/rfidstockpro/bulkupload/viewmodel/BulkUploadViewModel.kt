...
class BulkUploadViewModel : ViewModel() {
    ...
    val systemHeaders = listOf("Title", "Category", "Style No", "SKU", "Price", "Description")
    val mandatoryHeaders = systemHeaders.filterNot { it in listOf("Category", "SKU", "Price") }
      ...
      viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
          ...
          for (r in 1..sheet.lastRowNum) {
            ...
            val sku = normalizedHeaderMap["sku"]?.let { row.getCell(it)?.toString()?.trim() } ?: ""
